...
async function verifyJsonFarcasterSignature(data, verifyAppKey) {
    ...
    //
    const body = miniapp_core_1.encodedJsonFarcasterSignatureSchema.safeParse(data);
    ...
    const header = miniapp_core_1.jsonFarcasterSignatureHeaderSchema.safeParse(headerData);
